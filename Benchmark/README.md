...
I have tested both mods for months / years in harsch conditions, **they work perfectly, and exactly as the original Game Boy Camera**. The main difference for the user is the license associated to each project: no license for 2BitWizard (resale is allowed), [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en) for HDR. Unfortunately, this latter author is also known for actively [keeping files on people](https://github.com/HDR/Licence-Violation-Hall-Of-Shame) and online harassment. I can only recommend boycotting his mods as he has been literally rotting the entire Game Boy community with its dubious practices.
