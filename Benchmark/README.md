...
I have tested both mods for months/years in harsch conditions, **they work perfectly, and exactly as the original Game Boy Camera**, according to my demanding user experience. The main difference for the user is the license associated to each project: no license for 2BitWizard, CC BY-NC-SA 4.0 for HDR. Unfortunaltely, this latter is sick enough to actively keep files on people and publish them [online](https://github.com/HDR/Licence-Violation-Hall-Of-Shame), insult creators when his incomes are at stake and acts in clique with the most possible bad faith. I can only recommend running away from this author who spoils the entire retro community.
