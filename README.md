...
The original author is preparing a project release fixing the issues commented here. Use only if you have yet ordered the 1.4 PCB version. Wait until main branch update in other case.
