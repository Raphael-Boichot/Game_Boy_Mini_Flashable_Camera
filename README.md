...
## Funfacts
- The MAC-GBD I used here came from a PCB hosting the "rival" flashable camera mod because I wanted to definitely get rid of the last one I owned, so it was desoldered two times and soldered three times (one time in factory, two times by me on two different custom PCBs). My conclusion is that the MAC-GBD is rather forgiving in term of thermal budget.
