...
**A license free small flashable version of the original Game Boy Camera. A fork I've made for my own convenience but I assume it can be helpful to anyone wanting to do a flashable camera mod without having to seek for help online. The license (or absence of) allows you to do what you want with your device: sell it, change its design based on the comprehensive schematic provided, love or hate it, it just belongs to you, dear Game Boy Camera nerd.**
...
- 2BitWizard and I were harassed and insulted online by the author of the "rival" flashable camera mod who is no more than a little scumbag greedy for money, burst with jealousy at the slightest competition and taking too seriously his fucking toys (in brief: highly immature). This was probably my reward for making his mod for free many times, helping dozens of other modders troubleshooting it, and participating actively to the development of [Photo!](https://github.com/untoxa/gb-photo), the custom camera rom going with his mod. I had to open several lawsuits for defamation against him. Defamation was easily confirmed by a European court in application of the [GDPR](https://gdpr-info.eu/), for each reported online citation. Legal procedure is still ongoing today because social media head offices are located in the US, so it takes some time. Anyway, I'm now **very pissed** with all that shit because it maked me loose my precious time filling all that administrative shit to apply for lawsuits (I was hopefully very well helped by lawyers). You can see this fork as a way to help people switching to the 2BitWizard's mod, definitively.
