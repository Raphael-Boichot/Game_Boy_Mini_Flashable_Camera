...
## Funfacts
- The MAC-GBD I used here came from a PCB hosting the "rival" flashable camera mod, so it was desoldered two times and soldered three times (one time in factory, two times by me on two different custom PCBs). My conclusion is that the MAC-GBD is rather forgiving in term of thermal budget.
- I was harassed online by the author of the "rival" flashable camera mod who is a real scumbag. This was probaly my reward for making his mod for free many times and helping dozens of other modders. I had to open two separate lawsuits for defamation against him because this fucker publically puts side by side my real name and his droppings on different social media. Defamation was confirmed by a European court in march 2023. Legal procedure is slow but I now just have to wait for the hand of justice to crack down. Anyway, I'm now very pissed with all that shit. You can see this fork as a way to help people switching to the 2BitWizard's mod and stop giving money to that asshole.
