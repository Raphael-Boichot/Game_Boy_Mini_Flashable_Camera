...
|C2 to C9, C12 to C16, C19	|10nF	|14	|0603 |	Capacitor Ceramic (X7R)|[10 nf - 0603](https://fr.aliexpress.com/item/1005005690927737.html) - see notes|
...
- All the 10 nf caps could probably be changed by 100 nf if you want to reduce the number of parts to order. 100 nf is the default cap value for many cart mods. 
