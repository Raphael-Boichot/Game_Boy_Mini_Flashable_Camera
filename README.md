...
**A license free small flashable version of the original Game Boy Camera. A fork I've made for my own use but I assume it can be helpful to anyone wanting to do a flashable camera mod without having to seek for help online or give money to some sponsored asshole. The license (or absence of) allows you to do what you want with your device: sell it, destroy it, copy its design, criticize it, author does not care.**
...
## Funfacts
- The MAC-GBD I used here came from a PCB hosting the "rival" flashable camera mod because I wanted to definitely get rid of the last one I owned (nobody wanted it even for free), so it was desoldered two times and soldered three times (one time in factory, two times by me on two different custom PCBs). My conclusion is that the MAC-GBD is rather forgiving in term of thermal budget.
- I was harassed online by the author of the "rival" flashable camera mod who is a real scumbag. This was probably my reward for making his mod for free many times, helping dozens of other modders, and participating actively to the development of Photo!, the custom camera rom. I had to open several lawsuits for defamation against him because this fucker publically puts side by side my real name and his droppings on different social media. Defamation was hopefully confirmed by a European court in application of the [GDPR](https://gdpr-info.eu/), for each reported citation. Legal procedure is still ongoing today because social media head offices are located in the US but I just have to wait for the hand of justice to crack down as they must in any case comply to GDPR when having a foot in Europe. Anyway, I'm now very pissed with all that shit. You can see this fork as a way to definitely help people switching to the 2BitWizard's mod.
