...
- A 60W soldering iron with a fine tip and a temperature setting. This [kind of soldering iron](https://a.aliexpress.com/_EIEo07n) is **not** an option to consider unless you want to kill yourself;
...
- I learnt soldering surface mount stuff years ago by just watching Youtube and praticing, so it's not rocket science either. Hardware is the key: choose powerfull enough soldering iron with temperature control (the 2.5€ pen form factor irons sold on Aliexpress are **not** powerfull enough whatever the power advertised), good solder alloy, good soldering wick, flux in syringe, accurate magnifying device. Best is to start practicing soldering/desoldering with any whatever dead PCB, no need to buy online soldering kits that will end in a drawer.
